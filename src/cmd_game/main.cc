...
// This is our entry point to our application and we don't really make an effort in hiding all these platform specific things
...
int main(int, char**) {
  ...
  while (!done) {
    ...
    const float clear_color_with_alpha[4] = { 0.1f, 0.1f, 0.1f, 1.0 }; // dark gray
